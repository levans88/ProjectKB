...
<div style='text-indent: 10px; display: inline-block; clear: both; width: 100%; background-color: #F5F5F5; border-bottom: 1px solid #eee; border-top: 1px solid gray; padding-top: 15px;'>
...
<div style='float: left; padding-left: 15px;'>
	...
	<div style='display: inline-block; padding-left: 30px; padding-bottom: 15px;'>
			<label for='searchterm' style='font-size: 12px; font-weight: bold;'>Find:</label>
		...
		<form style='display: inline-block; padding-left: 0px; margin-left: -5px;' action='' method='post'>
